...
const Title: React.FC<TitleProps> = ({ variant, children }) => {
    return (
        <>
            ...
            {variant === 'h2' && (
                <h2 data-testid="title-testid" className="text-gray-900 text-display-sm">
                    {children}
                </h2>
            )}
            ...
            {variant === 'fwSB-fs48-lh60-lspN2-gray900' && (
                <h2
                    ...
                    className="text-display-md font-semibold leading-48 tracking-[-2%] text-gray-900 md:text-display-lg md:leading-64"
                >
                    {children}
                </h2>
            )}
